...
Further improvements would most likely require a different dataset, or more informative features, so no further attempts to increase the performance were made.
